...
function MyExperience(){
          ...
          <div className="hidden sm:block mt-32 px-10 ">
                    ...
                    <h1 className="text-[#070021] text-center font-medium text-5xl  ">MY WORK EXPERIENCES</h1>
          <div className="flex mt-10 justify-around">
                    <div className=" text-center">
                            ...
                            <Link to={"/projects"}><button className="bg-[#070021] mt-10 text-blue-500 px-5 py-2 rounded-2xl ">See more</button></Link>  
                    </div>
                    <div className=" text-center">
                             <i className="fa-solid fa-code text-blue-700 text-5xl "></i>
                             <h1 className="text-3xl font-semibold mt-5">Graphic Designer</h1>
                             <p className="w-72 mt-5">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quisquam magni natus porro sint, modi delectus! Deserunt quas velit quos, fugiat quis doloribus quaerat modi voluptate, consectetur quod libero ad dignissimos?</p>
                         < Link to={"/GraphicDesigner"}><button className="bg-[#070021] mt-10 text-blue-500 px-5 py-2 rounded-2xl ">See more</button></Link>
                         {/* <link> to={"GraphicDesigner"} <button className="bg-[#070021] mt-10 text-blue-500 px-5 py-2 rounded-2xl ">See more</button></link> */}
                    </div>
                    <div className=" text-center">
                             <i className="fa-solid fa-code text-blue-700 text-5xl "></i>
                             ...
                             <p className="w-72 mt-5">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quisquam magni natus porro sint, modi delectus! Deserunt quas velit quos, fugiat quis doloribus quaerat modi voluptate, consectetur quod libero ad dignissimos?</p>
                              <button className="bg-[#070021] mt-10 text-blue-500 px-5 py-2 rounded-2xl ">See more</button>
                    </div>
