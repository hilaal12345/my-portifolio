...
function About (){
          ...
          return <>
          <Header/>
           <div className="mt-10 mb-72  h-[600px] px-32 py-20 flex space-x-10">
                    <img className='w-[400px] h-[680px] border-4 border-blue-600 p-2 ' src={sawir1} alt="" />
                    
                    <div className="w-[700px]">
                              
                              <h1 className="text-black text-3xl mt-5 font-semibold">I'm Modern <span className="text-blue-600">Web Designer</span></h1>
                              ...
                              <button className='px-6 py-3 bg-[#070021] text-blue-600 font-semibold rounded-lg mt-8'>Download CV </button>
